 ...
 * 1) It provides an isEmpty implementation
 * based upon the abstract size() method.
 * 2) It defines a protected MapEntry class
 * as a concrete implementation of the
 * entry interface
 * 3) It provides implemenations of the keySet and values methods,
 * based upon use
